# pruna-test/test-save-tiny-random-llama4-smashed - Private, Uncensored AI for Real Creators and Devs

> Self-hosted **pruna-test/test-save-tiny-random-llama4-smashed** pipeline. Bypass corporate filters, keep your data local.
...
[![Visits](https://komarev.com/ghpvc/?username=damacol&label=Visits&color=blue&style=flat-square)](https://github.com/Damacol/pruna-test-test-save-tiny-random-llama4-smashed)
...
## Quick Start for pruna-test/test-save-tiny-random-llama4-smashed
...
2. Select the **pruna-test/test-save-tiny-random-llama4-smashed** model from the selector
